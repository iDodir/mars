...
class DeviceInField(models.Model):
    ...
    analyzer = models.ForeignKey(Device, on_delete=models.RESTRICT, verbose_name='Идентификатор')
...
class Order(models.Model):
    ...
    # todo dodir надо подумать над процессом движения прибора от клиента к клиенту, чтобы заявки не пропадали
    # todo dodir нужно ли поле для фиксации корректирующих действий? (Скорее всего да)
